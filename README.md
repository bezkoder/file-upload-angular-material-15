# Angular Material 15 File upload example with Progress bar

In this tutorial, I will show you way to build an Angular Material 15 File upload example using `@angular/material`, FormData and Progress Bar.

![file-upload-angular-material-15-example](file-upload-angular-material-15-example.png)

For more detail, please visit:
> [Angular Material 15 File upload example](https://www.bezkoder.com/angular-material-15-file-upload/)
